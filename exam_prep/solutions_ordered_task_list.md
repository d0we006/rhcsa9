...
nmcli con mod enp0s8 ipv4.method manual ipv4.addresses "192.168.0.18/24" ipv4.gateway "192.168.0.1" ipv4.dns "8.8.8.8" ipv6.method manual ipv6.addresses "fe80::a00:27ff:fe4d:56/64"
...
### Output shows `enp0s8` as unconfigured
nmcli con mod enp0s8 ipv4.method manual ipv4.addresses "192.168.0.19/24" ipv4.gateway "192.168.0.1" ipv4.dns "8.8.8.8" ipv6.method manual ipv6.addresses "fe80::a00:27ff:fe62:11c3/64"
nmcli con down enp0s8
nmcli con up enp0s8
nmcli general hostname rhcsa9-server1
...
scp /root/.ssh/* root@192.168.0.19:/root/.ssh
...
```
scp create* root@192.168.0.19:/root/
scp *.txt root@192.168.0.19:/root/
